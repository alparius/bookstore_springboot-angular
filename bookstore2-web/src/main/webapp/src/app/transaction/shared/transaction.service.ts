...
export class TransactionService {
    ...
    getTransactions(): Observable<Transaction[]> {
        return this.httpClient.get<Array<Transaction>>(this.transactionsUrl, {withCredentials: true});
    }
    ...
    save(clientId: number, bookId: number, details: string): Observable<Transaction> {
        ...
        return this.httpClient.post<Transaction>(this.transactionsUrl, transaction, {withCredentials: true});
    }
}
